        ...
        .row.g-0
          ...
          .col-xl-6.info-section
            .content-wrapper.px-lg-4.pt-lg-4.px-xxl-5.py-xxl-5.text-start
              ...
              p.descripcion.mb-4 La unidad aborda el Derecho Penal como instrumento del poder punitivo del Estado para regular conductas delictivas y proteger bienes jurídicos. Analiza su evolución histórica desde códigos antiguos como el de Hammurabi, hasta el Derecho Penal moderno y sus escuelas: Clásica, Positiva, Neoclásica, Funcionalista y Finalista. Se destacan los principios que limitan dicho poder, como legalidad, proporcionalidad, culpabilidad y presunción de inocencia. La unidad proporciona una base teórica para interpretar críticamente el castigo y su función en una justicia equitativa y garantista en sociedades democráticas.
